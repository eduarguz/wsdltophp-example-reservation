...
/**
 * This class stands for CurrencyCodeList EnumType
...
class CurrencyCodeList
{
    ...
    const VALUE_AOA = 'AOA';
    /**
     * Constant for value 'AON'
     * @return string 'AON'
     */
    const VALUE_AON = 'AON';
    /**
     * Constant for value 'AOR'
     * @return string 'AOR'
     */
    const VALUE_AOR = 'AOR';
    /**
