...
class X509DataType extends AbstractStructBase
{
     ...
     * @var \Sabre\UpdateReservation\StructType\X509IssuerSerialType
     */
     ...
     * @param \Sabre\UpdateReservation\StructType\X509IssuerSerialType $x509IssuerSerial
     ...
     */
    public function __construct(\Sabre\UpdateReservation\StructType\X509IssuerSerialType $x509IssuerSerial = null, $x509SKI = null, $x509SubjectName = null, $x509Certificate = null, $x509CRL = null, \DOMDocument $any = null)
    {
        $this
     ...
     * @return \Sabre\UpdateReservation\StructType\X509IssuerSerialType|null
     */
     ...
     * @param \Sabre\UpdateReservation\StructType\X509IssuerSerialType $x509IssuerSerial
     * @return \Sabre\UpdateReservation\StructType\X509DataType
     */
    public function setX509IssuerSerial(\Sabre\UpdateReservation\StructType\X509IssuerSerialType $x509IssuerSerial = null)
    {
     ...
     * @uses \DOMNode::item()
     * @uses \Sabre\UpdateReservation\StructType\X509DataType::setAny()
