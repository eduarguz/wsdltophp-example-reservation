...
/**
 * This class stands for SegmentOrTravelPortionType StructType
 * @subpackage Structs
 */
class SegmentOrTravelPortionType extends AbstractStructBase
{
    /**
     * The AirlineCode
     * Meta informations extracted from the WSDL
     * - documentation: Airline code
     * - minOccurs: 0
     * @var string
     */
    public $AirlineCode;
     ...
     * Meta informations extracted from the WSDL
     * - documentation: Marketing Carrier
     * - minOccurs: 0
     * @var string
     */
     ...
     * Meta informations extracted from the WSDL
     * - documentation: Operating Carrier
     * - minOccurs: 0
     * @var string
     */
    ...
    public $advisory;
    /**
     * Constructor method for SegmentOrTravelPortionType
     * @uses SegmentOrTravelPortionType::setAirlineCode()
     * @uses SegmentOrTravelPortionType::setFlightNumber()
     * @uses SegmentOrTravelPortionType::setOperatingFlightNumber()
     * @uses SegmentOrTravelPortionType::setClassOfService()
     * @uses SegmentOrTravelPortionType::setDepartureDate()
     * @uses SegmentOrTravelPortionType::setBoardPoint()
     * @uses SegmentOrTravelPortionType::setOffPoint()
     * @uses SegmentOrTravelPortionType::setEquipmentType()
     * @uses SegmentOrTravelPortionType::setETicketNumber()
     * @uses SegmentOrTravelPortionType::setETicketCoupon()
     * @uses SegmentOrTravelPortionType::setEMDNumber()
     * @uses SegmentOrTravelPortionType::setEMDCoupon()
     * @uses SegmentOrTravelPortionType::setMarketingCarrier()
     * @uses SegmentOrTravelPortionType::setOperatingCarrier()
     * @uses SegmentOrTravelPortionType::setId()
     * @uses SegmentOrTravelPortionType::setSequence()
     * @uses SegmentOrTravelPortionType::setAdvisory()
     ...
     * @param string $airlineCode
     * @return \Sabre\UpdateReservation\StructType\SegmentOrTravelPortionType
     */
