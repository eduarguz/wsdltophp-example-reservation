...
/**
 * This class stands for ShortSegmentAssociationTag.PNRB StructType
 * @subpackage Structs
 */
class ShortSegmentAssociationTag_PNRB extends AbstractStructBase
{
    /**
     * The CarrierCode
    ...
    /**
     * Constructor method for ShortSegmentAssociationTag.PNRB
     * @uses ShortSegmentAssociationTag_PNRB::setCarrierCode()
     * @uses ShortSegmentAssociationTag_PNRB::setFlightNumber()
     * @uses ShortSegmentAssociationTag_PNRB::setDepartureDate()
     * @uses ShortSegmentAssociationTag_PNRB::setBoardPoint()
     * @uses ShortSegmentAssociationTag_PNRB::setOffPoint()
     * @uses ShortSegmentAssociationTag_PNRB::setClassOfService()
     ...
     */
    public function __construct($carrierCode = null, $flightNumber = null, $departureDate = null, $boardPoint = null, $offPoint = null, $classOfService = null)
    {
        $this
     ...
     * @param string $carrierCode
     * @return \Sabre\UpdateReservation\StructType\ShortSegmentAssociationTag_PNRB
     */
