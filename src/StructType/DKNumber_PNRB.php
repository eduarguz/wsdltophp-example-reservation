...
/**
 * This class stands for DKNumber.PNRB StructType
 * @subpackage Structs
 */
class DKNumber_PNRB extends AbstractStructBase
{
    /**
     * The _
     * @var string
    ...
    public $op;
    /**
     * Constructor method for DKNumber.PNRB
     * @uses DKNumber_PNRB::set_()
     * @uses DKNumber_PNRB::setOp()
     * @param string $_
     * @param string $op
     */
    public function __construct($_ = null, $op = null)
    {
        $this
            ->set_($_)
            ->setOp($op);
     ...
     * Set _ value
     * @param string $_
     * @return \Sabre\UpdateReservation\StructType\DKNumber_PNRB
     */
