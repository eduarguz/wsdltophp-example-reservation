...
class SignatureMethodType extends AbstractStructBase
{
     ...
     * Set Algorithm value
     * @param string $algorithm
     * @return \Sabre\UpdateReservation\StructType\SignatureMethodType
     */
    ...
    public function setHMACOutputLength($hMACOutputLength = null)
    {
        ...
        if (!is_null($hMACOutputLength) && !is_numeric($hMACOutputLength)) {
            throw new \InvalidArgumentException(sprintf('Invalid value, please provide a numeric value, "%s" given', gettype($hMACOutputLength)), __LINE__);
        }
     ...
     * @uses \DOMNode::item()
     * @uses \Sabre\UpdateReservation\StructType\SignatureMethodType::setAny()
