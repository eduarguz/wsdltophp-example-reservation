...
class ObjectType extends AbstractStructBase
{
     ...
     */
    public function __construct(\DOMDocument $any = null, \Sabre\UpdateReservation\StructType\ID $id = null, $mimeType = null, $encoding = null)
    {
        $this
            ->setAny($any)
            ->setId($id)
     ...
     * @uses \DOMNode::item()
     * @uses \Sabre\UpdateReservation\StructType\ObjectType::setAny()
     ...
     * Set any value
     * @param \DOMDocument $any
     * @return \Sabre\UpdateReservation\StructType\ObjectType
     */
