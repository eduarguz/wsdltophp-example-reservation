...
/**
 * This class stands for FrequentFlierHistoryType StructType
 * @subpackage Structs
 */
class FrequentFlierHistoryType extends Loyalty_PNRB
{
    /**
     * The HistoryAction
    ...
    /**
     * Constructor method for FrequentFlierHistoryType
     * @uses FrequentFlierHistoryType::setHistoryAction()
     ...
     * @param string $historyAction
     * @return \Sabre\UpdateReservation\StructType\FrequentFlierHistoryType
     */
