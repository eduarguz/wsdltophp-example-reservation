...
/**
 * This class stands for ServiceProviderType StructType
 * @subpackage Structs
 */
class ServiceProviderType extends AbstractStructBase
{
     ...
     * Set Name value
     * @param string $name
     * @return \Sabre\UpdateReservation\StructType\ServiceProviderType
     */
    ...
    {
        foreach ($telephone as $serviceProviderTypeTelephoneItem) {
            // validation for constraint: itemType
            if (!$serviceProviderTypeTelephoneItem instanceof \Sabre\UpdateReservation\StructType\PhoneType) {
                throw new \InvalidArgumentException(sprintf('The Telephone property can only contain items of \Sabre\UpdateReservation\StructType\PhoneType, "%s" given', is_object($serviceProviderTypeTelephoneItem) ? get_class($serviceProviderTypeTelephoneItem) : gettype($serviceProviderTypeTelephoneItem)), __LINE__);
            }
        }
    ...
    {
        foreach ($address as $serviceProviderTypeAddressItem) {
            // validation for constraint: itemType
            if (!$serviceProviderTypeAddressItem instanceof \Sabre\UpdateReservation\StructType\AddressType) {
                throw new \InvalidArgumentException(sprintf('The Address property can only contain items of \Sabre\UpdateReservation\StructType\AddressType, "%s" given', is_object($serviceProviderTypeAddressItem) ? get_class($serviceProviderTypeAddressItem) : gettype($serviceProviderTypeAddressItem)), __LINE__);
            }
        }
