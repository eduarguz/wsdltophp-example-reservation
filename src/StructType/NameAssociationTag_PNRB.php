...
/**
 * This class stands for NameAssociationTag.PNRB StructType
 * @subpackage Structs
 */
class NameAssociationTag_PNRB extends AbstractStructBase
{
    /**
     * The LastName
    ...
    public $ReferenceId;
    /**
     * Constructor method for NameAssociationTag.PNRB
     * @uses NameAssociationTag_PNRB::setLastName()
     * @uses NameAssociationTag_PNRB::setFirstName()
     * @uses NameAssociationTag_PNRB::setPrefix()
     * @uses NameAssociationTag_PNRB::setNameRefNumber()
     * @uses NameAssociationTag_PNRB::setId()
     * @uses NameAssociationTag_PNRB::setReferenceId()
     ...
     * Set LastName value
     * @param string $lastName
     * @return \Sabre\UpdateReservation\StructType\NameAssociationTag_PNRB
     */
