...
/**
 * This class stands for TicketingHistoryType StructType
 * @subpackage Structs
 */
class TicketingHistoryType extends TicketDetailsType
{
    /**
     * The HistoryAction
    ...
    /**
     * Constructor method for TicketingHistoryType
     * @uses TicketingHistoryType::setHistoryAction()
     ...
     * @param string $historyAction
     * @return \Sabre\UpdateReservation\StructType\TicketingHistoryType
     */
