...
/**
 * This class stands for AirPosType.PNRB StructType
 * Meta informations extracted from the WSDL
 * - documentation: OAC POS details for segments
 * @subpackage Structs
 */
class AirPosType_PNRB extends AbstractStructBase
{
    /**
     * The CrsCode
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for AirPosType.PNRB
     * @uses AirPosType_PNRB::setCrsCode()
     * @uses AirPosType_PNRB::setIataNumber()
     * @uses AirPosType_PNRB::setAgencyCityCode()
     * @uses AirPosType_PNRB::setCountryCode()
     * @uses AirPosType_PNRB::setDutyCode()
     * @uses AirPosType_PNRB::setOACAccountingCityCode()
     * @uses AirPosType_PNRB::setOACAccountingCode()
     ...
     */
    public function __construct($crsCode = null, $iataNumber = null, $agencyCityCode = null, $countryCode = null, $dutyCode = null, $oACAccountingCityCode = null, $oACAccountingCode = null)
    {
        $this
            ->setCrsCode($crsCode)
     ...
     * Set CrsCode value
     * @param string $crsCode
     * @return \Sabre\UpdateReservation\StructType\AirPosType_PNRB
     */
