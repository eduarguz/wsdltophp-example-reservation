...
/**
 * This class stands for ETicketNumberType StructType
 * @subpackage Structs
 */
class ETicketNumberType extends AbstractStructBase
{
    /**
     * The _
     * @var string
    ...
    public $RPH;
    /**
     * Constructor method for ETicketNumberType
     * @uses ETicketNumberType::set_()
     * @uses ETicketNumberType::setId()
     * @uses ETicketNumberType::setIndex()
     * @uses ETicketNumberType::setOp()
     * @uses ETicketNumberType::setElementId()
     * @uses ETicketNumberType::setRPH()
     * @param string $_
     * @param string $id
     * @param int $index
     * @param string $op
     ...
     * @param string $rPH
     */
    public function __construct($_ = null, $id = null, $index = null, $op = null, $elementId = null, $rPH = null)
    {
        $this
            ->set_($_)
            ->setId($id)
     ...
     * Set _ value
     * @param string $_
     * @return \Sabre\UpdateReservation\StructType\ETicketNumberType
     */
