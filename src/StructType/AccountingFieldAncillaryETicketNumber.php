...
/**
 * This class stands for AccountingFieldAncillaryETicketNumber StructType
 * @subpackage Structs
 */
class AccountingFieldAncillaryETicketNumber extends AbstractStructBase
{
    /**
     * The ETicketNumber
    ...
    /**
     * Constructor method for AccountingFieldAncillaryETicketNumber
     * @uses AccountingFieldAncillaryETicketNumber::setETicketNumber()
     * @uses AccountingFieldAncillaryETicketNumber::setETicketCoupon()
     ...
     * @param string $eTicketNumber
     * @return \Sabre\UpdateReservation\StructType\AccountingFieldAncillaryETicketNumber
     */
