...
/**
 * This class stands for AncillaryServiceETicketNumberUpdate.PNRB StructType
 * @subpackage Structs
 */
class AncillaryServiceETicketNumberUpdate_PNRB extends AbstractStructBase
{
    /**
     * The ETicketNumber
    ...
    /**
     * Constructor method for AncillaryServiceETicketNumberUpdate.PNRB
     * @uses AncillaryServiceETicketNumberUpdate_PNRB::setETicketNumber()
     * @uses AncillaryServiceETicketNumberUpdate_PNRB::setETicketCoupon()
     ...
     * @param string $eTicketNumber
     * @return \Sabre\UpdateReservation\StructType\AncillaryServiceETicketNumberUpdate_PNRB
     */
