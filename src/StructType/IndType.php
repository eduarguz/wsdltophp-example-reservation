...
/**
 * This class stands for IndType StructType
 * @subpackage Structs
 */
class IndType extends AbstractStructBase
{
    /**
     * The ind
     * @var bool
    ...
    public $ind;
    /**
     * Constructor method for IndType
     * @uses IndType::setInd()
     * @param bool $ind
     */
     ...
     * Set ind value
     * @param bool $ind
     * @return \Sabre\UpdateReservation\StructType\IndType
     */
