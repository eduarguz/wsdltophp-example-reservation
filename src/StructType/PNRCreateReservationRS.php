...
/**
 * This class stands for PNRCreateReservationRS StructType
 * @subpackage Structs
 */
class PNRCreateReservationRS extends AbstractStructBase
{
    /**
     * The Reservation
    ...
    /**
     * Constructor method for PNRCreateReservationRS
     * @uses PNRCreateReservationRS::setReservation()
     * @uses PNRCreateReservationRS::setPOS()
     * @uses PNRCreateReservationRS::setRecordLocator()
     ...
     * @param \Sabre\UpdateReservation\StructType\Reservation_PNRB $reservation
     * @return \Sabre\UpdateReservation\StructType\PNRCreateReservationRS
     */
