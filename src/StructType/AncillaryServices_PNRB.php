...
/**
 * This class stands for AncillaryServices.PNRB StructType
 * @subpackage Structs
 */
class AncillaryServices_PNRB extends AbstractStructBase
{
    /**
     * The CommercialName
     * @var string
    ...
    public $elementId;
    /**
     * Constructor method for AncillaryServices.PNRB
     * @uses AncillaryServices_PNRB::setCommercialName()
     * @uses AncillaryServices_PNRB::setRficCode()
     * @uses AncillaryServices_PNRB::setRficSubcode()
     * @uses AncillaryServices_PNRB::setSSRCode()
     * @uses AncillaryServices_PNRB::setProductTextDetails()
     * @uses AncillaryServices_PNRB::setProductText()
     * @uses AncillaryServices_PNRB::setOwningCarrierCode()
     * @uses AncillaryServices_PNRB::setSsimCode()
     * @uses AncillaryServices_PNRB::setBookingIndicator()
     * @uses AncillaryServices_PNRB::setVendor()
     * @uses AncillaryServices_PNRB::setEMDType()
     * @uses AncillaryServices_PNRB::setEMDNumber()
     * @uses AncillaryServices_PNRB::setEMDCoupon()
     * @uses AncillaryServices_PNRB::setServiceFeeLineNumber()
     * @uses AncillaryServices_PNRB::setDisplayOnlyIndicator()
     * @uses AncillaryServices_PNRB::setConsumptionIndicator()
     * @uses AncillaryServices_PNRB::setPresentTo()
     * @uses AncillaryServices_PNRB::setAtCity()
     * @uses AncillaryServices_PNRB::setEndorsements()
     * @uses AncillaryServices_PNRB::setStationIndicator()
     * @uses AncillaryServices_PNRB::setServiceCity()
     * @uses AncillaryServices_PNRB::setServiceCityDestination()
     * @uses AncillaryServices_PNRB::setServiceType()
     * @uses AncillaryServices_PNRB::setRuleSet()
     * @uses AncillaryServices_PNRB::setAncillarySequenceNumber()
     * @uses AncillaryServices_PNRB::setOfferItemID()
     * @uses AncillaryServices_PNRB::setOriginalPrice()
     * @uses AncillaryServices_PNRB::setQuantity()
     * @uses AncillaryServices_PNRB::setSegmentNumber()
     * @uses AncillaryServices_PNRB::setEquivalentPrice()
     * @uses AncillaryServices_PNRB::setTTLPrice()
     * @uses AncillaryServices_PNRB::setPortionOfTravelIndicator()
     * @uses AncillaryServices_PNRB::setOriginalBasePrice()
     * @uses AncillaryServices_PNRB::setRefundIndicator()
     * @uses AncillaryServices_PNRB::setCommisionIndicator()
     * @uses AncillaryServices_PNRB::setInterlineIndicator()
     * @uses AncillaryServices_PNRB::setFeeApplicationIndicator()
     * @uses AncillaryServices_PNRB::setPassengerTypeCode()
     * @uses AncillaryServices_PNRB::setBoardPoint()
     * @uses AncillaryServices_PNRB::setOffPoint()
     * @uses AncillaryServices_PNRB::setTaxesIncluded()
     * @uses AncillaryServices_PNRB::setTaxes()
     * @uses AncillaryServices_PNRB::setSoftMatchIndicator()
     * @uses AncillaryServices_PNRB::setNoChargeNotAvailIndicator()
     * @uses AncillaryServices_PNRB::setTicketCouponNumberAssociation()
     * @uses AncillaryServices_PNRB::setSimultaneousTicketIndicator()
     * @uses AncillaryServices_PNRB::setFormOfRefund()
     * @uses AncillaryServices_PNRB::setFeeNotGuaranteedIndicator()
     * @uses AncillaryServices_PNRB::setFQTVTierLevel()
     * @uses AncillaryServices_PNRB::setTourCodeSHC()
     * @uses AncillaryServices_PNRB::setTravelDateEffective()
     * @uses AncillaryServices_PNRB::setLatestTravelDatePermitted()
     * @uses AncillaryServices_PNRB::setPurchaseByDate()
     * @uses AncillaryServices_PNRB::setTotalOriginalBasePrice()
     * @uses AncillaryServices_PNRB::setTotalEquivalentPrice()
     * @uses AncillaryServices_PNRB::setTotalTTLPrice()
     * @uses AncillaryServices_PNRB::setTotalTaxes()
     * @uses AncillaryServices_PNRB::setTaxExemptIndicator()
     * @uses AncillaryServices_PNRB::setBagWeight()
     * @uses AncillaryServices_PNRB::setFareCalculationModeIndicator()
     * @uses AncillaryServices_PNRB::setFareCalculationPriceIndicator()
     * @uses AncillaryServices_PNRB::setBagOccurence()
     * @uses AncillaryServices_PNRB::setStatusIndicator()
     * @uses AncillaryServices_PNRB::setNumberOfItems()
     * @uses AncillaryServices_PNRB::setActionCode()
     * @uses AncillaryServices_PNRB::setSegmentIndicator()
     * @uses AncillaryServices_PNRB::setFrequentFlyerTier()
     * @uses AncillaryServices_PNRB::setRefundFormIndicator()
     * @uses AncillaryServices_PNRB::setFareGuaranteedIndicator()
     * @uses AncillaryServices_PNRB::setServiceChargeIndicator()
     * @uses AncillaryServices_PNRB::setAdvancePurchaseIndicator()
     * @uses AncillaryServices_PNRB::setBookingSource()
     * @uses AncillaryServices_PNRB::setTaxIndicator()
     * @uses AncillaryServices_PNRB::setTicketingIndicator()
     * @uses AncillaryServices_PNRB::setFeeWaiveReason()
     * @uses AncillaryServices_PNRB::setFulfillmentType()
     * @uses AncillaryServices_PNRB::setAaPayOriginalSeat()
     * @uses AncillaryServices_PNRB::setPdcSeat()
     * @uses AncillaryServices_PNRB::setEquipmentType()
     * @uses AncillaryServices_PNRB::setAaPayOptionalStatus()
     * @uses AncillaryServices_PNRB::setFirstTravelDate()
     * @uses AncillaryServices_PNRB::setLastTravelDate()
     * @uses AncillaryServices_PNRB::setTTYConfirmationTimestamp()
     * @uses AncillaryServices_PNRB::setPurchaseTimestamp()
     * @uses AncillaryServices_PNRB::setBrandedFareId()
     * @uses AncillaryServices_PNRB::setGroupCode()
     * @uses AncillaryServices_PNRB::setTourCode()
     * @uses AncillaryServices_PNRB::setEmdPaperIndicator()
     * @uses AncillaryServices_PNRB::setSeatRequestTransactionID()
     * @uses AncillaryServices_PNRB::setTicketUsedForEMDPricing()
     * @uses AncillaryServices_PNRB::setEMDConsummedAtIssuance()
     * @uses AncillaryServices_PNRB::setPaperDocRequired()
     * @uses AncillaryServices_PNRB::setTaxExemption()
     * @uses AncillaryServices_PNRB::setACSCount()
     * @uses AncillaryServices_PNRB::setNetAmount()
     * @uses AncillaryServices_PNRB::setPriceQuoteDesignator()
     * @uses AncillaryServices_PNRB::setPriceMismatchAction()
     * @uses AncillaryServices_PNRB::setSegment()
     * @uses AncillaryServices_PNRB::setTravelPortions()
     * @uses AncillaryServices_PNRB::setId()
     * @uses AncillaryServices_PNRB::setOp()
     * @uses AncillaryServices_PNRB::setSequenceNumber()
     * @uses AncillaryServices_PNRB::setElementId()
     ...
     * @param string $commercialName
     * @return \Sabre\UpdateReservation\StructType\AncillaryServices_PNRB
     */
