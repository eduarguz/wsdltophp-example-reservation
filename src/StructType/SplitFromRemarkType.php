...
/**
 * This class stands for SplitFromRemarkType StructType
 * @subpackage Structs
 */
class SplitFromRemarkType extends BaseRemarkType
{
    /**
    ...
    /**
     * Constructor method for SplitFromRemarkType
     * @uses SplitFromRemarkType::setOriginalNumberOfPax()
     * @uses SplitFromRemarkType::setCurrentNumberOfPax()
     * @uses SplitFromRemarkType::setCurrentPassengerNames()
     ...
     * @param string $originalNumberOfPax
     * @return \Sabre\UpdateReservation\StructType\SplitFromRemarkType
     */
