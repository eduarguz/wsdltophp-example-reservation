...
/**
 * This class stands for CountryCodes StructType
 * @subpackage Structs
 */
class CountryCodes extends AbstractStructBase
{
    /**
     * The Code
    ...
    public $Code;
    /**
     * Constructor method for CountryCodes
     * @uses CountryCodes::setCode()
     ...
     * @param \Sabre\UpdateReservation\StructType\Code[] $code
     * @return \Sabre\UpdateReservation\StructType\CountryCodes
     */
    public function setCode(array $code = array())
    {
        foreach ($code as $countryCodesCodeItem) {
            // validation for constraint: itemType
            if (!$countryCodesCodeItem instanceof \Sabre\UpdateReservation\StructType\Code) {
                throw new \InvalidArgumentException(sprintf('The Code property can only contain items of \Sabre\UpdateReservation\StructType\Code, "%s" given', is_object($countryCodesCodeItem) ? get_class($countryCodesCodeItem) : gettype($countryCodesCodeItem)), __LINE__);
            }
        }
        $this->Code = $code;
        return $this;
