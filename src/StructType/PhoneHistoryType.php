...
/**
 * This class stands for PhoneHistoryType StructType
 * @subpackage Structs
 */
class PhoneHistoryType extends PhoneNumber_PNRB
{
    /**
     * The HistoryAction
    ...
    /**
     * Constructor method for PhoneHistoryType
     * @uses PhoneHistoryType::setHistoryAction()
     ...
     * @param string $historyAction
     * @return \Sabre\UpdateReservation\StructType\PhoneHistoryType
     */
