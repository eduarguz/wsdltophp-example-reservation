...
/**
 * This class stands for CorporateIDHistoryType StructType
 * @subpackage Structs
 */
class CorporateIDHistoryType extends CorporateID_PNRB
{
    /**
     * The HistoryAction
    ...
    /**
     * Constructor method for CorporateIDHistoryType
     * @uses CorporateIDHistoryType::setHistoryAction()
     ...
     * @param string $historyAction
     * @return \Sabre\UpdateReservation\StructType\CorporateIDHistoryType
     */
