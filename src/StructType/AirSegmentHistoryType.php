...
/**
 * This class stands for AirSegmentHistoryType StructType
 * @subpackage Structs
 */
class AirSegmentHistoryType extends AirType
{
    /**
     * The HistoryAction
    ...
    /**
     * Constructor method for AirSegmentHistoryType
     * @uses AirSegmentHistoryType::setHistoryAction()
     ...
     * @param string $historyAction
     * @return \Sabre\UpdateReservation\StructType\AirSegmentHistoryType
     */
