...
/**
 * This class stands for VehicleSegmentHistoryType StructType
 * @subpackage Structs
 */
class VehicleSegmentHistoryType extends VehicalType
{
    /**
     * The HistoryAction
    ...
    /**
     * Constructor method for VehicleSegmentHistoryType
     * @uses VehicleSegmentHistoryType::setHistoryAction()
     * @param string $historyAction
     */
    public function __construct($historyAction = null)
    {
        $this
     ...
     * @param string $historyAction
     * @return \Sabre\UpdateReservation\StructType\VehicleSegmentHistoryType
     */
