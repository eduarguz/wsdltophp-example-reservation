...
/**
 * This class stands for HotelSegmentHistoryType StructType
 * @subpackage Structs
 */
class HotelSegmentHistoryType extends HotelType
{
    /**
     * The HistoryAction
    ...
    /**
     * Constructor method for HotelSegmentHistoryType
     * @uses HotelSegmentHistoryType::setHistoryAction()
     ...
     * @param string $historyAction
     * @return \Sabre\UpdateReservation\StructType\HotelSegmentHistoryType
     */
