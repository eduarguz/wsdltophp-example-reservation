...
/**
 * This class stands for OACTypeHistory StructType
 * @subpackage Structs
 */
class OACTypeHistory extends OACType
{
    /**
     * The HistoryAction
    ...
    /**
     * Constructor method for OACTypeHistory
     * @uses OACTypeHistory::setHistoryAction()
     * @uses OACTypeHistory::setHistoryTimestamp()
     ...
     * @param string $historyAction
     * @return \Sabre\UpdateReservation\StructType\OACTypeHistory
     */
