...
/**
 * This class stands for Payment.PNRB StructType
 * @subpackage Structs
 */
class Payment_PNRB extends AbstractStructBase
{
    /**
     * The id
    ...
    public $RPH;
    /**
     * Constructor method for Payment.PNRB
     * @uses Payment_PNRB::setId()
     * @uses Payment_PNRB::setOp()
     * @uses Payment_PNRB::setRPH()
     * @param string $id
     * @param string $op
     * @param string $rPH
     */
    public function __construct($id = null, $op = null, $rPH = null)
    {
        $this
            ->setId($id)
            ->setOp($op)
     ...
     * Set id value
     * @param string $id
     * @return \Sabre\UpdateReservation\StructType\Payment_PNRB
     */
